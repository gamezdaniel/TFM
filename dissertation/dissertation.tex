...
\begin{itemize}
      ...
      For this purpose was employed a GNU GPL python script {INCLUDE INTO APPENDIX} published by Daniel Izquierdo Cortazar from GSyC/LibreSoft which uses the following query:\\
...
\noindent 
  ...
  DRBD's authors originally submitted the software to the Linux kernel community in July 2007.
  Ellenberg, Lars (2007-07-21). "DRBD wants to go mainline". linux-kernel (Mailing list). Retrieved 2007-08-03.

  Pacemaker:
  Until about 2007, it was part of the Linux-HA project, then was split out to be its own project.
