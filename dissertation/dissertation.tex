...
In the initial research over the internet, main F$\ell$OSS web-based source code repositories were consulted (listed in alphabetical order) in order to review the state of the art regarding F$\ell$OSS tools that could fit the requirements. However many of the related projects were currently hosted in Github.
...
\begin{itemize}
	...
	\item ``Red Hat Enterprise Linux 6 Cluster Administration". Red Hat, Inc. and others, 2014.\\
...
\begin{itemize}
	\item DRBD: Haas F., Reisner P. and Ellenberg L. ``The DRBD User's Guide". LINBIT Information Technologies GmbH and LINBIT HA Solutions GmbH. 2011.
...
\noindent Also specific related work was founded, such as:
...
\begin{itemize}
	...
	\item Miguel Vidal Lopez, Jose Castro Luis. ``Creacion de un cluster de alta disponibilidad con software libre". Novatica Journal. Nro 210. 2011. \\
	DOI=http://www.ati.es/novatica/2011/209/Nv209-75.pdf
\end{itemize}

\noindent Pending content..\\
- Analysing Libre Software communities~\cite{IandR}\\
- MetricsGrimoire~\cite{GSyC}\\
...
\noindent The proposed hypothesis of a search method by collecting and read as much information related to the project is available, results on the one hand, a task very well supported by the Internet facilities and lots of information available both officially and unofficially in the Web. Though on the other hand, this amount of information is not always available in an organized or easy way to digest, leading to an extensive analysis on many occasions that the companies are not willing to invest.\bigskip
